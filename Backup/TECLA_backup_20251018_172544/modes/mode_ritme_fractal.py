"""
Mode Ritme Fractal - Genera patrons rítmics basats en fractals del conjunt de Mandelbrot
"""
import time
import math
import random
...
class ModeRitmeFractal(BaseMode):
    def __init__(self, midi_out, config=None):
        super().__init__(midi_out, config)
        self.name = "Ritme Fractal"
    ...
    def setup(self):
        ...
        print(f"Mode Ritme Fractal iniciat. BPM: {self.bpm}")
    ...
    def stop(self):
        ...
        print("Mode Ritme Fractal aturat")
